...
include 'config.php';
$id = $_GET['id'];
$select = " SELECT * FROM undergrad WHERE id = '$id' ";
...
<html lang="en">
  <head>
    ...
    <title>Admission Fees Receipt</title>
...
$dompdf->stream("admission_fees.pdf", array("Attachment" => false));
exit(0);
?>
