...
$sql = "SELECT * FROM undergrad WHERE reg = '$reg' ";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <?php } ?>
    <h2 class="mt-3">Undergraduate Admission</h2>
        <table class="table table-light my-3">
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="ugPay.php?id=<?=$row['id']?>" class="btn btn-success <?php if($row['admission']=='Pending' || $row['admission']=='Declined'){echo "disabled";} ?> col-4 m-1" 
                    <?php if($row['fees']>=22264){echo "hidden";} ?>>Pay</a>
                    <a href="ugReceipt.php?id=<?=$row['id']?>" class="btn btn-success <?php if($row['admission']=='Pending' || $row['admission']=='Declined'){echo "disabled";} ?> col-4 m-1" 
