...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="logout.php"><button class="btn btn-outline-success my-2 my-sm-0">Logout</button>
    </div>
    </nav>
    ...
    <div class="card col-md-12 mb-4" style="width: 36rem;">
        <div class="card-body bg-dark">
            ...
            <p class="card-text">
                Your application for makeup examination has been sent to the Controller of Examination for approval.
            </p>
            <a href="makeupStatus.php" class="btn btn-primary stretched-link">Application Status</a>
