...
$sql = "SELECT * FROM library WHERE dregistrar = 'Approved' ORDER BY id DESC";
...
<head>
    <meta charset="UTF-8">
    <title>LU | Library Applications</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 80px;">Library Applications</h2>
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php if($rows['fees']==100){echo "Paid";} ?></td>
                    <td><?php echo $rows['hstatus']; ?></td>
                    <td><?php echo $rows['dregistrar']; ?></td>
                    
                    <td><a href="approveLib.php?col=librarian&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['librarian']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="declineLib.php?col=librarian&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
                    <?php if($rows['librarian']=='Approved' || $rows['librarian']=='Declined'){echo "hidden";} ?>>Decline</a>
                    <span <?php if($rows['librarian']=='Pending'){echo "hidden";} ?>><?php echo $rows['librarian']; ?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
