...
<main class="form-signin w-100 m-auto">
  <form action="LUPayID2.php" method="post">
    ...
    <div class="form-floating">
      <input type="number" class="form-control" id="floatingInput" name="fees" value="5000" readonly>
      <input type="number" class="form-control" id="floatingInput" name="id" value="<?php echo $id; ?>" hidden>
      <input type="text" class="form-control" id="floatingInput" name="page" value="<?php echo "orig"; ?>" hidden>
