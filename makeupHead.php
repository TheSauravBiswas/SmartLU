...
$sql = "SELECT * FROM makeup WHERE dept = '$myDept' AND ctstatus = 'Approved' ORDER BY id DESC";
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="approveMU.php?col=hstatus&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['hstatus']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="declineMU.php?col=hstatus&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
                    <?php if($rows['hstatus']=='Approved' || $rows['hstatus']=='Declined'){echo "hidden";} ?>>Decline</a>
                    <span <?php if($rows['hstatus']=='Pending'){echo "hidden";} ?>><?php echo $rows['hstatus']; ?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
