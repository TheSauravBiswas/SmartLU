...
$sql = "SELECT * FROM makeup WHERE hstatus = 'Approved' ORDER BY id DESC";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <h2 style="padding-top: 80px;">Makeup Applications</h2>
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="approveMU.php?col=cstatus&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['cstatus']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="declineMU.php?col=cstatus&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
                    <?php if($rows['cstatus']=='Approved' || $rows['cstatus']=='Declined'){echo "hidden";} ?>>Decline</a>
                    <span <?php if($rows['cstatus']=='Pending'){echo "hidden";} ?>><?php echo $rows['cstatus']; ?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
