...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 80px;">Admit Card</h2>
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php if($rows['fees']>=$rows['beforemid']){echo "Paid";}else{echo "Due";} ?></td>
                    <td><a href="midAdmit.php?id=<?=$rows['id']?>" 
                    class="btn btn-success <?php if($rows['fees']<$rows['beforemid']){echo "disabled";} ?> d-grid">Download</a></td>
                </tr>
                <tr>
                    <th scope="row"><?=$i?></th>
                    <td>Final</td>
                    <td><?php echo $rows['semester']; ?></td>
                    <td><?php if($rows['fees']>=$rows['totalfee']){echo "Paid";}else{echo "Due";} ?></td>
                    <td><a href="finalAdmit.php?id=<?=$rows['id']?>" 
                    class="btn btn-success <?php if($rows['fees']<$rows['totalfee']){echo "disabled";} ?> d-grid">Download</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
