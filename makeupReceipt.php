...
<html lang="en">
  <head>
    ...
    <title>Makeup Exam Fee Receipt</title>
  ...
  <body>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                <th scope="row">Makeup Exam Fee</th>
                <td>'.$fees.' TK</td>
            </tr>
            <tr>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                <th scope="row">Library Card Fee</th>
                <td>'.$fees.' TK</td>
            </tr>
            <tr>
                <th scope="row">Total Amount Payable</th>
...
$dompdf->stream("makeup_receipt.pdf", array("Attachment" => false));
exit(0);
?>
