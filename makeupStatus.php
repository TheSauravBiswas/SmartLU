...
$sql = "SELECT * FROM makeup WHERE sid = '$sid' ORDER BY id DESC";
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $rows['cteacher']; ?></td>
                    <td><?php echo $rows['exam']; ?></td>
                    <td><a href="readPDF.php?docp=<?=$rows['docp']?>" class="btn btn-info d-grid" target="_blank">View</a></td>
                    <td><?php echo $rows['ctstatus']; ?></td>
                    <td><?php echo $rows['hstatus']; ?></td>
                    <td><?php echo $rows['cstatus']; ?></td>
                    
                    <td><a href="makeupPay.php?exam=<?=$rows['exam']?>&id=<?=$rows['id']?>" class="btn btn-success <?php if($rows['cstatus']=='Pending' || $rows['cstatus']=='Declined'){echo "disabled";} ?> d-grid m-1" 
                    <?php if($rows['fees']>=2000){echo "hidden";} ?>>Pay</a>
                    <a href="makeupReceipt.php?sid=<?=$rows['sid']?>&exam=<?=$rows['exam']?>" class="btn btn-success <?php if($rows['cstatus']=='Pending' || $rows['cstatus']=='Declined'){echo "disabled";} ?> d-grid m-1" 
                    <?php if($rows['fees']>=2000){echo "hidden";} ?>>Receipt</a>
                    <span <?php if($rows['fees']<2000){echo "hidden";} ?>>Paid</span></td>
                    
                    <td><a href="makeupAdmit.php?id=<?=$rows['id']?>" 
                    class="btn btn-success <?php if($rows['fees']<2000){echo "disabled";} ?> d-grid">Download</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
