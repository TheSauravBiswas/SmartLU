...
$sql = "SELECT * FROM tuitionfees WHERE hstatus = 'Approved' ORDER BY id DESC";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 80px;">Applications</h2>
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="readPDF.php?docp=<?=$rows['docp']?>" class="btn btn-info m-1" target="_blank">View</a></td>
                    <td><?php echo $rows['hstatus']; ?></td>
                    
                    <td><a href="approve70.php?col=registrar&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['registrar']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="decline70.php?col=registrar&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
                    <?php if($rows['registrar']=='Approved' || $rows['registrar']=='Declined'){echo "hidden";} ?>>Decline</a>
                    <span <?php if($rows['registrar']=='Pending'){echo "hidden";} ?>><?php echo $rows['registrar']; ?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
