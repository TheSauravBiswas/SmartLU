...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 85px;">Graduate Admission</h2>
        <table class="table table-light my-3">
            <tbody>
                <form action="approveGrad.php" method="post">
                <tr>
                ...
                <tr>
                    <th scope="row">Honours Group</th>
                    <td><?php echo $row['gradgroup']; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><button type="submit" class="btn btn-success m-1 col-4" name="grad" 
                    <?php if($row['admission']=='Approved'){echo "hidden";} ?>>Approve</button>
                    <a href="declineGrad.php?id=<?=$row['id']?>" class="btn btn-danger m-1 col-4" 
