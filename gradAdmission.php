...
$sql = "SELECT * FROM grad ORDER BY id DESC";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <h2 style="padding-top: 80px;">Graduate Admission</h2>
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $rows['sscyear']; ?></td>
                    <td><?php echo $rows['sscins']; ?></td>
                    <td><?php echo $rows['hscyear']; ?></td>
                    <td><?php echo $rows['hscins']; ?></td>
                    <td><?php echo $rows['gradyear']; ?></td>
                    <td><?php echo $rows['gradins']; ?></td>
                    <?php if($rows['admission']=="Pending"){ ?><td class="text-danger"><b><?php echo $rows['admission']; ?></b></td><?php }elseif($rows['admission']=="Approved"){ ?>
                    <td class="text-success"><b><?php echo $rows['admission']; ?></b></td><?php }elseif($rows['admission']=="Declined"){ ?>
                    <td><b><?php echo $rows['admission']; ?></b></td><?php }else{ ?>
                    <td><b><?php echo $rows['admission']; ?></b></td><?php } ?>
                    <td><a href="gradDetails.php?id=<?=$rows['id']?>" class="btn btn-info d-grid">Check</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
