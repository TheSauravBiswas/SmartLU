...
$gidcard = $bc = $wd = $ap = $gp = $st = $ht = $tm = $gid = $sbc = $password =  "";
...
$ssctransErr = $hsctransErr = $testimonialErr = $gidcardErr = $bcErr = $selectreg=$resultsreg=$dbErr= "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif(empty($_FILES["bc"]['name'])){
        ...
        testimonial, gidcard, bc, password, admission, fees, status) 
        ...
        '$tm', '$gid', '$sbc', '$password', 'Pending', '0', 'ugapplicant')";
        ...
        if($result){
            ...
            $mail->Body    = "Dear ".$name.","."<br>". "We have received your application for admission in undergraduate 
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 85px;">Undergraduate Admission Form</h2>
        <?php if ($dbErr) { ?>
        ...
        <?php if(isset($_SESSION['logger'])){ ?>
            <a class="mb-4" href="ugStatus.php"><b>Already applied? Click here to view applicaiton status.</b></a>
        <?php }else{ ?>
            <a class="mb-4" href="uStatusLogin.php"><b>Already applied? Click here to view applicaiton status.</b></a>
        <?php } ?>
            <div class="form-group">
                ...
                <select id="" class="form-select" aria-label="Default select example" name="program">
                    ...
                    <option>Bachelor of Tourism and Hospitality Management</option>
                    <option>BA in English</option>
                    <option>BA in Bangla</option>
                    <option>Bachelor of Laws</option>
                    <option>BA in Islamic Studies</option>
                    <option>B.Sc in Computer Science and Engineering</option>
                    <option>B.Sc in Electrical and Electronic Engineering</option>
                    <option>Bachelor of Architecture</option>
                    <option>B.Sc in Civil Engineering</option>
                </select>
