...
$sql = "SELECT * FROM library WHERE sid = '$sid' ";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
$alert = "Your application for Library Card is in process.";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="UTF-8">
    <title>LU | Library Card Application</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 85px;">Library Card Application</h2>
        <table class="table table-light my-3">
            <tbody>
                <tr>
                    <th scope="row">Library Card Fees</th>
                    <td>100TK (Paid)</td>
                </tr>
                <tr>
