...
$sql = "SELECT * FROM tuitionfees WHERE dept = '$myDept' ORDER BY id DESC";
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="approve70.php?col=hstatus&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['hstatus']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="decline70.php?col=hstatus&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
