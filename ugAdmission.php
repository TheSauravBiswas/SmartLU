...
$sql = "SELECT * FROM undergrad ORDER BY id DESC";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <h2 style="padding-top: 80px;">Undergraduate Admission</h2>
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="ugDetails.php?id=<?=$rows['id']?>" class="btn btn-info d-grid">Check</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
