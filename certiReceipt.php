...
$sid = $_GET['id'];
$fees = $_GET['fees'];
if($fees==3000||$fees==4500){
    $cf = "Provisional";
}elseif($fees==5000||$fees==6500){
    $cf = "Original";
}
...
<html lang="en">
  <head>
    ...
    <title>Certificate Receipt</title>
  ...
  <body>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                <th scope="row">Certificate Fee ('.$cf.')</th>
                <td>'.$fees.' TK</td>
            </tr>
            <tr>
...
$dompdf->stream("library_receipt.pdf", array("Attachment" => false));
exit(0);
?>
