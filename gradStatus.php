...
$reg = $_SESSION['logger']['reg'];
$sql = "SELECT * FROM grad WHERE reg = '$reg' ";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <?php } ?>
    <h2 class="mt-3">Graduate Admission</h2>
        <table class="table table-light my-3">
            <tbody>
                ...
                <tr>
                    <th scope="row">Honours Year</th>
                    <td><?php echo $row['gradyear']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Honours Institution</th>
                    <td><?php echo $row['gradins']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Honours Subject</th>
                    <td><?php echo $row['gradsub']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Honours Roll</th>
                    <td><?php echo $row['gradroll']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Honours CGPA</th>
                    <td><?php echo $row['gradgpa']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Application for Special Waiver</th>
                    <td><?php echo $row['quota']; ?></td>
                </tr>
                <?php if($row['quotadoc']) { ?>
                <tr>
                    <th scope="row">Document Supporting Eligibility of Special Waiver</th>
                    <td><a href="readPDF.php?docp=<?=$row['qoutadoc']?>" class="btn btn-info col-4" target="_blank">View</a></td>
                </tr>
                <?php } ?>
                <tr>
                    <th scope="row">Waiver</th>
                    <td><?php echo $row['waiver']; ?>%</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row">Honours Transcript</th>
                    <td><a href="readPDF.php?docp=<?=$row['gradtrans']?>" class="btn btn-info col-4" target="_blank">View</a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row">Approval of Admission</th>
                    <td><?php echo $row['admission']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Admission Fees</th>
                    <td><a href="gradPay.php?id=<?=$row['id']?>" class="btn btn-success <?php if($row['admission']=='Pending' || $row['admission']=='Declined'){echo "disabled";} ?> col-4 m-1" 
                    <?php if($row['fees']>=22264){echo "hidden";} ?>>Pay</a>
                    <a href="gradReceipt.php?id=<?=$row['id']?>" class="btn btn-success <?php if($row['admission']=='Pending' || $row['admission']=='Declined'){echo "disabled";} ?> col-4 m-1" 
                    <?php if($row['fees']>=22264){echo "hidden";} ?>>Receipt</a>
                    <span <?php if($row['fees']<22264){echo "hidden";} ?>>Paid</span></td>
                </tr>
            </tbody>
        </table>
