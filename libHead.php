...
$sql = "SELECT * FROM library WHERE dept = '$myDept' ORDER BY id DESC";
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="approveLib.php?col=hstatus&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['hstatus']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="declineLib.php?col=hstatus&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
