...
$sql = "SELECT * FROM certificate WHERE sid = '$sid' ORDER BY id DESC ";
...
<head>
    <meta charset="UTF-8">
    <title>LU | Provisional Certificate</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
    <h2 style="padding-top: 85px;">Provisional Certificate</h2>
        <table class="table table-light my-3">
            <tbody>
                ...
                <tr>
                    <th scope="row">Approval of Deputy Registrar</th>
                    <td><?php echo $row['dregistrar']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Approval of Assistant Controller</th>
                    <td><?php echo $row['acontroller']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Approval of Librarian</th>
                    <td><?php echo $row['librarian']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Approval of Dept. Head</th>
                    <td><?php echo $row['hstatus']; ?></td>
                </tr>
                <tr>
                    <th scope="row">Approval of Director, Finance & Accounts</th>
                    <td><?php echo $row['dfa']; ?></td>
                </tr>
                <tr>
