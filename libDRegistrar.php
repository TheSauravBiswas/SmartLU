...
$sql = "SELECT * FROM library WHERE hstatus = 'Approved' ORDER BY id DESC";
        ...
        <table class="table table-light my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="approveLib.php?col=dregistrar&id=<?=$rows['id']?>" class="btn btn-success m-1 d-grid" 
                    <?php if($rows['dregistrar']=='Approved'){echo "hidden";} ?>>Approve</a>
                    <a href="declineLib.php?col=dregistrar&id=<?=$rows['id']?>" class="btn btn-danger m-1 d-grid" 
                    <?php if($rows['dregistrar']=='Approved' || $rows['dregistrar']=='Declined'){echo "hidden";} ?>>Decline</a>
                    <span <?php if($rows['dregistrar']=='Pending'){echo "hidden";} ?>><?php echo $rows['dregistrar']; ?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
